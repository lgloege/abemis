...
def enteric_fermentation_ch4(N, EF):
    r"""CH4 emissions from enteric fermentation.
...
def manure_management_ch4(N, EF):
    r"""CH4 emissions from manure management.
...
def manure_management_n2o(N, NEX, MS, EF):
    r"""N2O emissions from manure management.
...
def delta_c(FL, CL, GL, WL, SL, OL):
    r"""Emissions from changes in ecosystem C stocks.
...
def biomass_burning(A, B, CF, EF):
    r"""Emissions from biomass burning.
...
def urea_fertilization(M, EF):
    r"""CO2 emissions from urea application.
...
def manure_management_n2o_indirect(n, nex, ms, frac, ef):
    """Indirect N2O emissions from  volatilization of N from manure management.
...
def rice_cultivation_ch4(EF, T, A):
    r"""CH4 emissions from rice cultivation.
